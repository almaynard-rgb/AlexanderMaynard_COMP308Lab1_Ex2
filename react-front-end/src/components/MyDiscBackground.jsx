...
//this is the component that will be used to create the game disc shape that is to the login and register pages background
function MyDiscBackground() {
  ...
  useEffect(() => {
    ...
    //Note: multiple discs are used to create the final disc shape with separate colors
  ...
  return (
    //set the refContainer styles to be the size of the window and the z-index to be -1 so that it is behind the login and register pages items
    <div ref={refContainer} style={{position: "absolute", top: 0, left: 0, width:"100%", height: "100%", zIndex: -1 }}></div>

  );
}

export default MyDiscBackground; //export the component